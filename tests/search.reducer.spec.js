...
import SearchMovies, {getMovieDetails} from '../app/src/modules/searchMovies';
import {SEARCH, FETCHING, SET_MOVIE_DETAILS, fetchMovies} from '../app/src/modules/searchMovies';
...
describe('It will test the initial state and the FETCH and SEARCH actions', () => {
    ...
    test('handles SEARCH action as expected', () => {
        const action = {
            type: SEARCH,
            value: 'Trailer 1',
            results: {
        ...
        newState.totalResults = 1;
        newState.search_keywords = "Trailer 1";
        newState.movies = [
            {
                "poster_path": "/pMdTc3kYCD1869UX6cdYUT8Xe49.jpg",
                "adult": false,
    ...
    test('handles FETCHING action as expected', () => {
        const action = {
            type: FETCHING,
            value: true,
        };
    ...
    it('fetchMovies() action creator', () => {

        const expectedActions = [
            {type: FETCHING, 'value': true},
            {
                type: SEARCH, value: 'test keywords',
                results: {
                    "page": 1,
                    "movies": [
                        {
    ...
    it('getMovieDetails() action creator', () => {
        ...
        const expectedActions = [
            {type: FETCHING, 'value': true},
            {
                type: SET_MOVIE_DETAILS, 'movieDetails': {
                    "homepage": undefined,
                    "id": 565,
                    "originalLanguage": "en",
                    "originalTitle": "The Ring",
